import{n as e,x as t}from"./iframe-NBvccbGJ.js";import{E as n,d as r,m as i,s as a,x as o}from"./dist-3JGc6B6X.js";import{t as s}from"./rolldown-runtime-Dh6celcD.js";var c,l,u,d,f,p;function m(){return(m=s((()=>{n(),e(),c={title:`Inputs/TagsInput`,component:i,tags:[`autodocs`],args:{id:`topics`,label:`Topics`,placeholder:`Add a topic`,clearable:!0,separator:`,`,maxTags:6},argTypes:{disabled:{control:`boolean`},readonly:{control:`boolean`},clearable:{control:`boolean`},required:{control:`boolean`},separator:{control:`text`},maxTags:{control:`number`},size:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]},radius:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]}}},l={render:e=>({components:{TagsInput:i},setup(){return{args:e,value:t([`Vue`,`Accessibility`])}},template:`<TagsInput v-bind="args" v-model="value" /><p>Selected: {{ value.join(", ") }}</p>`})},u={render:()=>({components:{Stack:r,TagsInput:i,Text:a},setup(){return{normal:t([`Vue`,`TypeScript`]),limited:t([`Vue`,`Rust`])}},template:`
      <Stack gap="md">
    ...
    `})},d={render:()=>({components:{Stack:r,TagsInput:i,Text:a},setup(){return{value:t([`Design`])}},template:`
      <Stack gap="sm">
        <TagsInput
          id="skills-pipe"
          v-model="value"
    ...
    `})},f={render:()=>({components:{Group:o,Stack:r,TagsInput:i,Text:a},setup(){return{skills:t([`Vue`,`Accessibility`]),interests:t([`Design systems`])}},template:`
      <Stack gap="lg">
