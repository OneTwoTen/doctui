import{n as e,x as t}from"./iframe-Diz0RuqM.js";import{L as n,M as r,_ as i,c as a,u as o,y as s}from"./dist-uIANVeSe.js";import{t as c}from"./rolldown-runtime-Dh6celcD.js";var l,u,d,f,p,m,h,g;function _(){return(_=c((()=>{r(),e(),l={title:`Inputs/TagsInput`,component:a,tags:[`autodocs`],args:{id:`topics`,label:`Topics`,placeholder:`Add a topic`,clearable:!0,separator:`,`,maxTags:6},argTypes:{disabled:{control:`boolean`},readonly:{control:`boolean`},clearable:{control:`boolean`},required:{control:`boolean`},separator:{control:`text`},maxTags:{control:`number`},size:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]},radius:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]}}},u={render:e=>({components:{TagsInput:a},setup(){return{args:e,value:t([`Vue`,`Accessibility`])}},template:`<TagsInput v-bind="args" v-model="value" /><p>Selected: {{ value.join(", ") }}</p>`})},d={render:()=>({components:{Stack:s,TagsInput:a},setup(){return{xs:t([`Vue`,`Rust`]),sm:t([`Vue`,`Rust`]),md:t([`Vue`,`Rust`]),lg:t([`Vue`,`Rust`]),xl:t([`Vue`,`Rust`])}},template:`
      <Stack gap="md">
    ...
    `})},f={render:()=>({components:{Stack:s,TagsInput:a,Text:o},setup(){return{normal:t([`Vue`,`TypeScript`]),limited:t([`Vue`,`Rust`])}},template:`
      <Stack gap="md">
    ...
    `})},p={render:()=>({components:{Button:n,Stack:s,TagsInput:a,Text:o},setup(){let e=t([`Vue`,`Accessibility`]),n=t([]);return{skills:e,submitted:n,submit:e=>{let t=e.currentTarget;n.value=new FormData(t).getAll(`skills`).map(e=>String(e))}}},template:`
    ...
    `})},m={render:()=>({components:{Stack:s,TagsInput:a,Text:o},setup(){return{value:t([`Design`])}},template:`
      <Stack gap="sm">
        <TagsInput
          id="skills-pipe"
          v-model="value"
    ...
    `})},h={render:()=>({components:{Group:i,Stack:s,TagsInput:a,Text:o},setup(){return{skills:t([`Vue`,`Accessibility`]),interests:t([`Design systems`])}},template:`
      <Stack gap="lg">
