import{A as e,H as t,N as n,R as r,U as i,c as a,tt as o,x as s}from"./iframe-DlC1x03z.js";import{t as c}from"./rolldown-runtime-Dh6celcD.js";var l,u,d,f,p,m,h,g;function _(){return(_=c((()=>{e(),i(),l={title:`Inputs/TagsInput`,component:s,tags:[`autodocs`],args:{id:`topics`,label:`Topics`,placeholder:`Add a topic`,clearable:!0,separator:`,`,maxTags:6},argTypes:{disabled:{control:`boolean`},readonly:{control:`boolean`},clearable:{control:`boolean`},required:{control:`boolean`},separator:{control:`text`},maxTags:{control:`number`},size:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]},radius:{control:`select`,options:[`xs`,`sm`,`md`,`lg`,`xl`]}}},u={render:e=>({components:{TagsInput:s},setup(){return{args:e,value:o([`Vue`,`Accessibility`])}},template:`<TagsInput v-bind="args" v-model="value" /><p>Selected: {{ value.join(", ") }}</p>`})},d={render:()=>({components:{Stack:t,TagsInput:s},setup(){return{xs:o([`Vue`,`Rust`]),sm:o([`Vue`,`Rust`]),md:o([`Vue`,`Rust`]),lg:o([`Vue`,`Rust`]),xl:o([`Vue`,`Rust`])}},template:`
      <Stack gap="md">
    ...
    `})},f={render:()=>({components:{Stack:t,TagsInput:s,Text:a},setup(){return{normal:o([`Vue`,`TypeScript`]),limited:o([`Vue`,`Rust`])}},template:`
      <Stack gap="md">
    ...
    `})},p={render:()=>({components:{Button:n,Stack:t,TagsInput:s,Text:a},setup(){let e=o([`Vue`,`Accessibility`]),t=o([]);return{skills:e,submitted:t,submit:e=>{let n=e.currentTarget;t.value=new FormData(n).getAll(`skills`).map(e=>String(e))}}},template:`
    ...
    `})},m={render:()=>({components:{Stack:t,TagsInput:s,Text:a},setup(){return{value:o([`Design`])}},template:`
      <Stack gap="sm">
        <TagsInput
          id="skills-pipe"
          v-model="value"
    ...
    `})},h={render:()=>({components:{Group:r,Stack:t,TagsInput:s,Text:a},setup(){return{skills:o([`Vue`,`Accessibility`]),interests:o([`Design systems`])}},template:`
      <Stack gap="lg">
